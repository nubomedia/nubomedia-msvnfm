...
public class MediaServerResourceManagement {
  ...
  @Async
  public Future<Boolean> release(VNFCInstance vnfcInstance, VimInstance vimInstance)
      throws VimException {
    log.debug(
  ...
  private VNFCInstance getVnfcInstanceFromServer(
      VimInstance vimInstance,
      VNFComponent vnfComponent,
      String hostname,
      Server server,
  ...
  private String chooseImage(Collection<String> vm_images, VimInstance vimInstance)
      throws VimException {
  ...
  private String getUserdata(String hostname, VirtualNetworkFunctionRecord vnfr) {
    ...
    variables.put(
        ...
        Boolean.toString(mediaServerProperties.getTurnServer().isActivate()));
    ...
    variables.put(
        "$STUN_SERVER_ACTIVATE",
        Boolean.toString(mediaServerProperties.getStunServer().isActivate()));
