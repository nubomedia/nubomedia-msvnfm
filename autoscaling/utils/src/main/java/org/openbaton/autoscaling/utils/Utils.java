...
public class Utils {
  ...
  public static VimInstance getVimInstance(
      List<String> vimInstanceNames, List<VimInstance> vimInstances) throws NotFoundException {
    ...
    throw new NotFoundException(
        "VimInstances with names: "
            + vimInstanceNames
            + " were not found in the provided list of VimInstances.");
  }

  public static VimInstance getVimInstance(
      List<String> vimInstanceNames, NFVORequestor nfvoRequestor) throws NotFoundException {
  ...
  public static int getCpuCoresOfFlavor(
      String deployment_flavour_key, List<String> vimInstanceNames, NFVORequestor nfvoRequestor)
